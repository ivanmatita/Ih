...
/* Fix: Corrected map iteration variable 'row' to 'r' on lines 324-336 to resolve "Cannot find name 'r'" error */
const renderModelo1Row = (mapData: any[], f: (n: number) => string) => (
    <tbody>
        {mapData.map(r => (
